...
wget -nc https://github.com/vercel/geist-font/releases/download/1.3.0/GeistMono-1.3.0.zip
wget -nc https://github.com/vercel/geist-font/releases/download/1.3.0/Geist-1.3.0.zip
